                    ...
                    <AnimatePresence>
                        ...
                        >
                            <Disclosure.Panel>
                                ...
                                <div className="flex items-center justify-center px-4 pb-5 pt-2 text-sm w-full text-center gap-x-4">
                                    <motion.div
                                        whileHover={{ scale: 0.9 }}
                                        whileTap={{ scale: 0.8 }}
                                        className="flex items-center gap-x-2 justify-center border-2 rounded-md border-white/10 p-2 w-full cursor-pointer"
                                    >
                                        <svg
                                            xmlns="http://www.w3.org/2000/svg"
                                            fill="none"
